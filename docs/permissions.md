...
| Exchange admin | `EXO_` | Graph: `ExchangeMessageTrace.Read.All`, `Place.Read.All`, `Reports.Read.All`. Office 365 Exchange Online: `Exchange.ManageAsAppV2` plus the custom view-only role group described in the guide |
